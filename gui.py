...
class MainWindow(QWidget):
    ...
    def open_window(self, window: Type[QWidget]) -> None:
        """
        Opens the window that is passed
        Args:
            window (Type[QWidget]): The window class being opened.
        """
        self.window = window()
        self.window.show()
...
class PlanWorkoutWindow(QWidget):
    ...
    def __init__(self) -> None:
        ...
        self.workout_type_combo.currentTextChanged.connect(self.on_workout_type_changed)
        ...
        update_visibility(self.widgets, "Cardio")

        self.add_workout_button = QPushButton("Add Workout")
        self.add_workout_button.clicked.connect(self.save_workout_data)
    ...
    def on_workout_type_changed(self, workout_type: str) -> None:
        """
        Updates the visibility of the form entries
        Args:
            workout_type (str): The selected workout type
        """
        update_visibility(self.widgets, workout_type)

    def save_workout_data(self) -> None:
        """
        Collects user input, validates the data, and saves the workout details.
        Displays a success message or error message (if the data is invalid).
        """
        try:
    ...
    def clear_inputs(self) -> None:
        """
        Clears all input fields, resetting the form to its default state (minds relevant data (the day, workout_type etc.)).
        """
...
class ViewWorkoutWindow(QWidget):
    ...
    def __init__(self):
        ...
        self.remove_checked_button = QPushButton("Clear Selected Workouts")
    ...
    def confirm_clear_workouts(self) -> None:
        """
        Displays a confirmation box before clearing all windows.
        """
    ...
    def clear_workouts(self):
        "Clears all workouts from the CSV and the tree widget."
        clear_workouts()
        self.tree_widget.clear()

    def remove_checked_items(self):
        """
        Removes selected workouts from the tree widget.
        Updates the CSV and refreshes the tree widget.
        """
        entries = []
